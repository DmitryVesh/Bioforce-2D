...
namespace GameServer
{
    public class ServerRead
    {
        public static void WelcomeRead(int clientID, Packet packet)
        {
            ...
            Debug.Log($"{Server.ClientDictionary[clientID].tCP.Socket.Client.RemoteEndPoint} connected as player: {clientID}");
            if (clientID == checkClientID)
            {
                Server.ClientDictionary[clientID].SendIntoGame(username);
                Debug.Log($"Player: {clientID} was sent into game.");
                return;
            }
            Debug.Log($"Error, player {username} is connected as wrong player number");
        }
        public static void UDPTestRead(int clientID, Packet packet)
        {
            ...
            Debug.Log($"UDP Test received from: {checkClientID}, Message: {message}\n");
            if (clientID == checkClientID)
            {
                return;
            }
            Debug.Log($"Error, player {clientID} is connected as wrong player number {checkClientID}");
        }
        public static void PlayerMovementRead(int clientID, Packet packet)
        {
            ...
            {
                Debug.Log($"Error, trying to read player movement, when a player: {clientID} has disconnected...\n{exception}");
            }
        }
        public static void PlayerMovementStatsRead(int clientID, Packet packet)
        {
            ...
            {
                Debug.Log($"Error, trying to read player movement stats, from player: {clientID}\n{exception}");
            }
        ...
        public static void ShotBulletRead(int clientID, Packet packet)
        {
            ...
            {
                Debug.Log($"Error, trying to read shot bullet, from player: {clientID}\n{exception}");
            }
        }
        ...
        public static void PlayerDiedRead(int clientID, Packet packet)
        {
            ...
            {
                Debug.Log($"Error, trying to read player died, from player: {clientID}\n{exception}");
            }
        }
        public static void PlayerRespawnedRead(int clientID, Packet packet)
        {
            ...
            {
                Debug.Log($"Error, trying to read player respawned, from player: {clientID}\n{exception}");
            }
        }
        ...
        public static void TookDamageRead(int clientID, Packet packet)
        {
            ...
            {
                Debug.Log($"Error, trying to read player took damage, from player: {clientID}\n{exception}");
            }
        }
